...
depicted conceptually in @fig-SI01. Without prior knowledge of where the
high-density region lies, numerical methods must evaluate the integrand at
...
value.](./fig/supplementary/figSI_gaussian_peak.png){#fig-SI01}
