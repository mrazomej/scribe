...
be modeled as a product of independent negative binomial distributions sharing
the same underlying $p$ (giving a common effective $\hat{p}$ per cell); see
@sec-dirichlet-multinomial. When dealing with heterogeneous cell
