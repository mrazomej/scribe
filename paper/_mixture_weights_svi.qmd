...
\left\langle 
    ...
    \underline{\pi})
\right\rangle_{q_\phi(\underline{\theta}, \underline{\pi})}
-
\text{KL}\left(
...
\underbrace{
    \frac{\partial}{\partial \alpha_k} \left\langle 
        \sum_{c=1}^{C} \log \pi(\underline{u}_c \mid \underline{\theta}, 
        \underline{\pi})
    \right\rangle_{q}
...
$$
\langle \pi_k \mid \underline{\underline{U}}, \underline{\theta} \rangle = 
...
$$
\langle \pi_k \rangle \approx \frac{N_k}{C}.
