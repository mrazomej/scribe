...
**What happens if we relax this assumption?** That is,
...
We next address how to generate compositional samples $\underline{\rho}$ when
the $p_g$ are gene-specific. As explained in @sec-diffexp-nonparametric, the empirical
...
directly with the existing analysis framework.
