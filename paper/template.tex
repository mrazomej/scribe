...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
$if(biblatex)$
% Biblatex is already loaded by Quarto, so we just configure it
...
$for(by-author)$
\author[$for(by-author.affiliations)$$it.number$$sep$,$endfor$$if(by-author.email)$,*$endif$]{$by-author.name.literal$}
$endfor$
...
$for(by-author)$
$if(by-author.email)$
\affil[*]{Corresponding author: $by-author.email$}
$endif$
$endfor$
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
