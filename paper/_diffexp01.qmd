...
**Why the probabilistic model matters** (@sec-diffexp-why-model): After
establishing the robustness of compositional point estimates, we address the
natural counter-argument: if simple normalization recovers the same
compositions, why use a probabilistic model at all? We show that the
