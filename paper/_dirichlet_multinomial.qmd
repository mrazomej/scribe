...
the product of a Poisson and a multinomial distribution. The overdispersion of
UMI counts was accounted as external noise rather than an intrinsic property of
the gene expression profiles. The goal of their model was then to estimate the
probability parameters for the multinomial distribution; using them as the
equivalent of the normalized gene expression counts.
