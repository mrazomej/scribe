...
Since we only need the determinat of the original matrix, and the modifications
we made do not affect the determinant, computing the determinant of
$\det(\underline{\underline{J}}')$ satisfies our needs. We can compute
