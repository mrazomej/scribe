...
$$
\langle (\underline{X} - \underline{Y})(\underline{X} - \underline{Y})^{\top} \rangle = 
\langle \underline{X}\underline{X}^{\top} \rangle - 
\langle \underline{X}\underline{Y}^{\top} \rangle - 
\langle \underline{Y}\underline{X}^{\top} \rangle + 
\langle \underline{Y}\underline{Y}^{\top} \rangle.
$${#eq-diffexp-cov-expansion-step2}

By independence, $\langle \underline{X}\underline{Y}^{\top} \rangle =
\langle \underline{X} \rangle\langle \underline{Y} \rangle^{\top}$ and
$\langle \underline{Y}\underline{X}^{\top} \rangle =
\langle \underline{Y} \rangle\langle \underline{X} \rangle^{\top}$. Therefore,
