...
The posterior expected false discovery proportion (PEFP) is a Bayesian analog
of the false discovery rate. We derive an efficient algorithm for finding lfsr
thresholds that control PEFP at a specified level.
