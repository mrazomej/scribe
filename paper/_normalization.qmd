...
observed UMI count matrix. The fundamental question is: how do we characterize
the distribution of normalized expression proportions
...
Why not simply fit a single Dirichlet distribution to the mean normalized
expression $\bar{\underline{\rho}}$? Let us define
...
The logistic-normal distribution is a flexible approximation to the
...
$\underline{\underline{V}}$. We obtain these eigenvalues and
...
The computational efficiency of our approach relies on several algorithmic
choices. Below, we quantify the memory and runtime advantages.
