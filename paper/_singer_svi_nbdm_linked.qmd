...
We have shown how to reparameterize the model in a way that captures the
correlation between the $p$ and $\underline{r}$ parameters. This leads to a significant improvement in the performance of the
