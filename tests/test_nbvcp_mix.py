...
def test_log_likelihood(example_nbvcp_mix_results, small_dataset, rng_key):
    ...
    cell_log_liks = example_nbvcp_mix_results.compute_log_likelihood(
        counts=counts, 
        cells_axis=0,
        return_by='cell',
    ...
    assert cell_log_liks.shape[1] == example_nbvcp_mix_results.n_cells  # n_cells
    
    # Test with split_components=True
    cell_log_liks_split = example_nbvcp_mix_results.compute_log_likelihood(
        counts=counts, 
        cells_axis=0,
        return_by='cell',
    ...
    assert cell_log_liks_split.shape[1] == example_nbvcp_mix_results.n_cells  # n_cells
    assert cell_log_liks_split.shape[2] == N_COMPONENTS  # n_components
    
    # Test gene-wise likelihood without split_components
    gene_log_liks = example_nbvcp_mix_results.compute_log_likelihood(
        counts=counts, 
        cells_axis=0,
        return_by='gene',
        split_components=False
    ...
    assert gene_log_liks.shape[1] == example_nbvcp_mix_results.n_genes  # n_genes
    
    # Test gene-wise likelihood with split_components
    gene_log_liks_split = example_nbvcp_mix_results.compute_log_likelihood(
        counts=counts, 
        cells_axis=0,
        return_by='gene',
        split_components=True
    ...
    assert gene_log_liks_split.shape[1] == example_nbvcp_mix_results.n_genes  # n_genes
...
def test_log_likelihood_batching(example_nbvcp_mix_results, small_dataset, rng_key):
    ...
    full_log_liks = example_nbvcp_mix_results.compute_log_likelihood(
        counts=counts, 
        cells_axis=0,
        return_by='cell',
        split_components=False
    ...
    batched_log_liks = example_nbvcp_mix_results.compute_log_likelihood(
        counts=counts, 
    ...
    # Compute log likelihood without batching
    full_log_liks_split = example_nbvcp_mix_results.compute_log_likelihood(
        counts=counts, 
        cells_axis=0,
        return_by='cell',
        split_components=True
    ...
    # Compute log likelihood with batching
    batched_log_liks_split = example_nbvcp_mix_results.compute_log_likelihood(
        counts=counts, 
        batch_size=5,  # Small batch size for testing
        cells_axis=0,
        return_by='cell',
