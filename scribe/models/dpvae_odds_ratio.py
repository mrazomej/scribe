"""
dpVAE-based models for single-cell RNA sequencing data using odds ratio
...
from .vae_odds_ratio import nbdm_vae_guide, zinb_vae_guide
...
def make_nbdm_dpvae_model_and_guide(
    ...
    def configured_model(
        ...
        """FIXED: Model function uses decoupled prior with odds ratio parameterization"""
    ...
    def configured_guide(
        ...
        """FIXED: Guide function uses encoder outputs properly with odds ratio parameterization"""
