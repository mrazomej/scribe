...
def make_nbdm_vae_model_and_guide(
    ...
    Binomial-Dirichlet Multinomial (NBDM) model with odds ratio parameterization,
    reusing the same encoder and decoder modules throughout the SVI optimization.
    ...
    def configured_model(
        ...
        """
        Model function for the NBDM VAE with odds ratio parameterization,
    ...
    def configured_guide(
        ...
        """
        Guide function for the NBDM VAE with odds ratio parameterization,
...
def make_zinb_vae_model_and_guide(
    ...
    Negative Binomial (ZINB) model with odds ratio parameterization, reusing
    the same encoder and decoder modules throughout the SVI optimization.
    ...
    def configured_model(
        ...
        """
        Model function for the ZINB VAE with odds ratio parameterization,
        using the shared decoder module.
    ...
    def configured_guide(
        ...
        """
        Guide function for the ZINB VAE with odds ratio parameterization,
        using the shared encoder module.
