"""
VAE-based models for single-cell RNA sequencing data using linked
parameterization.

This parameterization differs from the standard parameterization in that
the mean parameter (mu) is linked to the success probability parameter (p)
through the relationship:
    r = mu * (1 - p) / p
where r is the dispersion parameter. The VAE generates mu parameters for
each cell while keeping p interpretable.
"""
...
def zinb_vae_guide(
    ...
    """
    Mean-field variational guide for the VAE-based ZINB model with linked
    parameterization.
    """
...
# ------------------------------------------------------------------------------
# Posterior Distributions for VAE-based models with linked parameterization
# ------------------------------------------------------------------------------
