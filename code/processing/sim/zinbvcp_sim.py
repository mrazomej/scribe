...
# Define prior for gate parameter
gate_prior = (0.1, 1)
...
gate_true = random.beta(key4, gate_prior[0], gate_prior[1], shape=(n_genes,))
...
if not os.path.exists(output_file):
    ...
    for i in range(0, n_cells, batch_size):
        ...
        # Sample from zero-inflated distribution
        batch_samples = dist.ZeroInflatedDistribution(
            base_dist,
            gate=gate_true
        ).sample(key5, sample_shape=(1,))
