...
fig.savefig(f"{FIG_DIR}/example_ECDF_{suffix}.png", bbox_inches="tight")
...
fig.suptitle(r"Genes $r$ posterior distributions", y=1.005, fontsize=18)
...
distribution = results[int(np.sort(selected_idx)[i])].get_distributions()["p"]
