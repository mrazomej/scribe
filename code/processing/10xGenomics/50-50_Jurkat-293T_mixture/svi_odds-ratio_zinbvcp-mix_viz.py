...
print("Plotting UMI total counts histogram...")
...
# Set labels
ax.set_xlabel("UMI total counts")
ax.set_ylabel("# cells")

# Save figure
fig.savefig(
    f"{FIG_DIR}/umi_total_counts_histogram.png",
    bbox_inches="tight"
)
...
svi_results.get_posterior_samples(n_samples=500)
