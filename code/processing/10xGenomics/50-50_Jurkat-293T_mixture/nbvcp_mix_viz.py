...
mean_counts = np.median(data.X.toarray(), axis=0)
...
selected_idx = np.sort(sorted_idx[spaced_indices])
...
# Save figure
fig.savefig(f"{FIG_DIR}/kl_divergence.png", bbox_inches="tight")
# %% ---------------------------------------------------------------------------
