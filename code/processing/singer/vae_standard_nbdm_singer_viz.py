...
# Save figure
fig.savefig(
    f"{FIG_DIR}/vae_{parameterization}_{latent_dim}latentdim_loss.png", 
    bbox_inches="tight"
)
...
# Save figure
fig.savefig(
    f"{FIG_DIR}/vae_{parameterization}_{latent_dim}latentdim_latent_embeddings.png", 
    bbox_inches="tight"
)
...
vae_results.get_posterior_samples_from_data(data)

# Generate predictive samples
vae_results.get_predictive_samples(data)
