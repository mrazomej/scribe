...
fig.savefig(
    ...
    f"unconstrained_"
    f"{latent_dim}latentdim_loss.png",
    bbox_inches="tight",
)
...
latent_embeddings = vae_results.get_latent_embeddings(data)
...
fig.savefig(
    f"{FIG_DIR}/dpvae_{parameterization.replace('_', '-')}_"
    f"unconstrained_"
    f"{latent_dim}latentdim_latent_embeddings.png",
    bbox_inches="tight",
)
...
fig.savefig(
    f"{FIG_DIR}/dpvae_{parameterization.replace('_', '-')}_"
    f"unconstrained_"
    f"{latent_dim}latentdim_latent_samples.png",
    bbox_inches="tight",
)
# %% ---------------------------------------------------------------------------
...
fig.savefig(
    f"{FIG_DIR}/dpvae_{parameterization.replace('_', '-')}_"
    f"unconstrained_"
    f"{latent_dim}latentdim_latent_samples_density.png",
    bbox_inches="tight",
)
# %% ---------------------------------------------------------------------------
...
vae_results.get_posterior_samples(n_samples=1_000, canonical=True)

# Generate predictive samples
vae_results.get_predictive_samples()
...
for i, ax in enumerate(axes):
    ...
    credible_regions = scribe.stats.compute_histogram_credible_regions(
        vae_results.predictive_samples[:, :, i],
...
fig.savefig(
    f"{FIG_DIR}/dpvae_{parameterization.replace('_', '-')}_"
    f"unconstrained_"
    f"{latent_dim}latentdim_ppc.png",
    bbox_inches="tight",
)
...
fig.savefig(
    f"{FIG_DIR}/dpvae_{parameterization.replace('_', '-')}_"
    f"unconstrained_"
    f"{latent_dim}latentdim_ppc_ecdf.png",
    bbox_inches="tight",
)
# %% ---------------------------------------------------------------------------
...
vae_results.get_posterior_samples_conditioned_on_data(
    data, n_samples=1_000, canonical=True
)
