...
#SBATCH --job-name=mcmc_jurkat_h100         # Job name
...
#SBATCH --mem-per-gpu=60G                   # Request 60GB of host RAM per GPU. H100s have 80GB VRAM; adjust host RAM as needed.
#SBATCH --time=1-00:00:00                   # Time limit (D-HH:MM:SS), e.g., 1 day. Adjust based on expected runtime.

#SBATCH --output=logs/mcmc_h100_job-%j.out  # Standard output log (%j expands to jobID)
#SBATCH --error=logs/mcmc_h100_job-%j.err   # Standard error log
...
PYTHON_SCRIPT="./code/processing/10xGenomics/50-50_Jurkat-293T_mixture/mcmc_nbdm_lognormal_mix_gpu.py"
