...
4. **Result Loading and Visualization**:
   ...
   imported and then called to generate and save standardized figures—such as
   loss curves, ECDF plots, and posterior predictive checks—to the output
   directory.
...
standardized diagnostic and results visualizations—ensuring consistency,
