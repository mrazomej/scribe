...
| `gene_coverage < 1.0` AND `correlate_other_column=False` (explicit opt-in) — PLN | Engine raises `NotImplementedError` *before* obs-model construction with a clear pointer at Commit 5. |
