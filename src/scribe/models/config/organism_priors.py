...
``capture_prior`` is set to ``"biology_informed"`` (or auto-promoted via
``shared_capture_scaling=True``) and the user specifies ``organism``
instead of providing explicit hyperparameters.
...
ORGANISM_PRIORS: Dict[str, OrganismPrior] = {
    "human": {"total_mrna_mean": 200_000, "total_mrna_log_sigma": 0.5},
    "mouse": {"total_mrna_mean": 200_000, "total_mrna_log_sigma": 0.5},
    "yeast": {"total_mrna_mean": 60_000, "total_mrna_log_sigma": 0.5},
    "ecoli": {"total_mrna_mean": 3_000, "total_mrna_log_sigma": 0.5},
}
