...
@register(model_type="nbdm", parameterization="standard", inference_methods=["vae"], prior_type="standard")
def nbdm_vae_model(
    n_cells: int,
    n_genes: int,
...
@register(model_type="nbvcp", parameterization="standard", inference_methods=["vae"], prior_type="standard")
def nbvcp_vae_model(
    n_cells: int,
    n_genes: int,
    model_config: ModelConfig,
...
@register(model_type="nbdm", parameterization="standard", inference_methods=["vae"], prior_type="decoupled")
...
@register(model_type="nbvcp", parameterization="standard", inference_methods=["vae"], prior_type="decoupled")
