"""ZINBVCP (Zero-Inflated NB with Variable Capture Probability) presets.

This module provides factory functions for creating ZINBVCP model and guide
functions with various configurations.

The ZINBVCP model combines zero-inflation with variable capture probability:
    p_eff = p * p_capture
    counts ~ ZeroInflatedNegativeBinomial(gate, r, p_eff)
...
---------
create_zinbvcp
    Create ZINBVCP model and guide functions.

Examples
--------
>>> from scribe.models.presets import create_zinbvcp
...
>>>
>>> # With amortized p_capture and low-rank for mu
>>> model, guide = create_zinbvcp(
...
def create_zinbvcp(
    ...
    model_builder.with_likelihood(ZINBWithVCPLikelihood())
