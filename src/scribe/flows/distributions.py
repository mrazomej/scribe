...
SlicedTransform
    ...
    vector.  Used by the concatenated joint flow guide.
"""
...
# SlicedTransform was previously defined here. It now lives in
# scribe.stats.transforms (alongside scribe.stats.distributions, the
# canonical home for custom NumPyro subclasses) so that the
# Jacobian-corrected MAP dispatch in scribe.stats.jacobian_map can
# import it at module load without triggering the
# scribe.flows -> scribe.models -> scribe.flows circular import.
# Re-exported here for backward compatibility.
from scribe.stats.transforms import SlicedTransform  # noqa: F401
